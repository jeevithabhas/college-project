    ...
    <div className="bg-gradient-to-r from-blue-50 to-blue-100 p-8 rounded-lg shadow-xl max-w-2xl mx-auto mt-10 transform transition-all duration-500 hover:scale-105">
      ...
      <ul className="space-y-6">
        {applications.map((app) => (
          <li
            key={app._id}
            className="p-5 border-l-4 rounded-lg shadow-sm bg-white flex justify-between items-center hover:shadow-lg transition-transform transform hover:scale-105"
          >
            <div>
            ...
            {app.applicationStatus === "Submitted" && (
              <span className="px-3 py-1 ml-2 text-xs font-semibold text-white bg-green-500 rounded-full">
                ✅ Submitted
              </span>
            )}
          </li>
